# Generated by Django 3.0.7 on 2020-06-11 00:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boat_type', models.CharField(choices=[('Cruiser/Racer', 'Cruiser'), ('Catamaran', 'Catamaran'), ('Monohull', 'Monohull')], default='Cruiser/Racer', max_length=50)),
                ...
                ('sale_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Lease', 'For Rent')], default='For Sale', max_length=50)),
