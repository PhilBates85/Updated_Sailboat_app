...
class Listing(models.Model):
    ...
    class BoatType(models.TextChoices):
        CRUISER = 'Cruiser/Racer'
        CATAMARAN = 'Catamaran'
        MONOHUll = 'Monohull'

    slug = models.CharField(max_length=200, unique=True)
    title = models.CharField(max_length=150)
    boat_type = models.CharField(max_length=50, choices=BoatType.choices, default=BoatType.CRUISER)
    ...
    #to prevent loss of the listing if the broker is deleted
    ...
    open_boat = models.BooleanField(default=False)
